package com.evanokhttp3lib.handler;
...
import com.evanokhttp3lib.bean.DownloadMessage;
import com.evanokhttp3lib.bean.ProgressMessage;
import com.evanokhttp3lib.bean.UploadMessage;
import com.evanokhttp3lib.callback.BaseActivityLifecycleCallbacks;
import com.evanokhttp3lib.callback.BaseCallback;
import com.evanokhttp3lib.callback.CallbackOk;
                ...
                case RESPONSE_CALLBACK://网络请求
                    ...
                    if(null != callMsg.callback){
                        ...
                        if(!BaseActivityLifecycleCallbacks.isActivityDestroyed(callMsg.requestTag)){
                            ...
                            } else if(callback instanceof com.evanokhttp3lib.callback.Callback){
                                HttpInfo info = callMsg.info;
                                if(info.isSuccessful()){
                                    ((com.evanokhttp3lib.callback.Callback)callback).onSuccess(info);
                                }else{
                                    ((com.evanokhttp3lib.callback.Callback)callback).onFailure(info);
                                }
